...
xcrun swiftc -swift-version 5 -O -module-cache-path .tmp/module-cache \
  Sources/main.swift Sources/Routing.swift Sources/DisplayRecovery.swift Sources/RoutingDiagnostics.swift Sources/SignalCapture.swift -framework AppKit -framework IOKit \
